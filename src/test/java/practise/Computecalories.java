...
Explaination: calories[0] + calories[1] > upper, calories[2] + calories[3] < lower, total points = 0.
    ...
    public void test(){
        ...
        int k=3, lower=3, upper=3;
        //calculateCalories(calories,k,lower,upper);
    }

//    private int calculateCalories(int[] calories, int k, int lower, int upper) {
//
//    }
}
