...
public class P4_StringToInteger {
    /*
...
s consists of English letters (lower-case and upper-case), digits (0-9), ' ', '+', '-', and '.'.
    ...
    private int convertToInteger(String s) {
        ...
        /*
        Over flow conversion
        if(Integer.MAX_VALUE/10<result || Integer.MAX_VALUE/10==result && Integer.MAX_VALUE%10<chars[0]){
           isNegative==1?Integer.MIN_VALUE:Integer.MAX_VALUE;
        }
         */
